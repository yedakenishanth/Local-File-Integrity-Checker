...
* **`file\_integrity\_checker.py`** — desktop GUI (Python + Tkinter)
* **`web/`** — browser version with a live demo hosted on GitHub Pages

## Live demo

**https://yedakenishanth.github.io/Local-File-Integrity-Checker/web/** *(replace `YOUR-USERNAME` after you push — see "Enable the live demo" below)*
...
```bash
python3 file\_integrity\_checker.py
```
